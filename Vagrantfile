...
Vagrant.configure("2") do |config|
  ...
  # doesn't already exist on the user's system.  # config.vm.box_url = "centos7"
  ...
  config.vm.define "master" do |server|
     ...
     # private network
     server.vm.network :private_network, ip:"192.168.33.11", virtualbox__intnet:"kubernetes"
  ...
  config.vm.define "node1" do |server|
     ...
     # private network
     server.vm.network :private_network, ip:"192.168.33.12", virtualbox__intnet:"kubernetes"
  ...
  config.vm.define "node2" do |server|
     ...
     # private network
     server.vm.network :private_network, ip:"192.168.33.13", virtualbox__intnet:"kubernetes"
  ...
  config.vm.define "node3" do |server|
     ...
     # private network
     server.vm.network :private_network, ip:"192.168.33.14", virtualbox__intnet:"kubernetes"
  ...
  config.vm.define "ansible" do |server|
     ...
     # private network
     server.vm.network :private_network, ip:"192.168.33.10", virtualbox__intnet:"kubernetes"
